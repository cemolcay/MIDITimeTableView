...
Pod::Spec.new do |s|
  ...
  s.version      = "0.0.1"
  s.summary      = "A short description of MIDITimeTableView."
  ...
  s.homepage     = "http://EXAMPLE/MIDITimeTableView"
  ...
  s.source       = { :git => "http://EXAMPLE/MIDITimeTableView.git", :tag => "#{s.version}" }
